...
<img src="https://github.com/gui-bus/TechIcons/blob/main/Dark/Python.svg" alt="Sample Image" width="400" height="300">Código central usado para carregar os modelos de ia, fazer a conexão do front end com o back end.
